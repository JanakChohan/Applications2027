...
(async () => {
  const src = 'file://' + path.resolve(__dirname, 'guide_source.html');
  const out = path.resolve(__dirname, 'JPMorgan_Private_Bank_2027_London_Internship_Guide.pdf');
  ...
  await page.pdf({
    ...
    footerTemplate: `<div style="width:100%;font-size:8px;color:#666;padding:0 16mm;display:flex;justify-content:space-between;font-family:Helvetica,Arial,sans-serif;">
      <span>J.P. Morgan Global Private Bank 2027 London Internship Guide</span>
